...
<!--  -->
  ...
  <script type="text/javascript">
    var phone_number = '+1 844-706-3195';

  </script>

<script async defer src="https://tools.luckyorange.com/core/lo.js?site-id=e7d523a1"></script>
  </head>
  ...
  <div class="bxweb">
           ...
           <div style="font-size:40px;">
            ...
            <button type="button" class="btn btn-secondary btn-lg">
              Submit</button>
       <button type="button" class="btn back-button btn-lg blink"><span class="text">All Adult Sites</span><span class="link-icon"></span></button>
            </div>
  ...
  <div class="bxcontb" style="display: block;" id="webgetcode">
    ...
    <strong class="haru"><img src="images/call.png" alt="" class="blink" style="width: 25px;margin-left: 0;"> <script>document.write(phone_number);</script> (US Free Toll Call)</strong>
  </div>
  ...
  <div class="vislnb" id="botgnws" style="display: block;">
    ...
    <div class="col-md-12">
      ...
      <strong class="haruto"><img src="images/call.png" alt="" class="blink" style="width: 25px;margin-left: 0;"> <script>document.write(phone_number);</script> (US Free Toll Call)</strong>
      <div class="fr button blink" id="ftrs_btn">
      <a href="#" class="blink">I Understand</a>
      </div>
    </div>
    </div>
  </div>
  ...
  <div id="ftrs">
    ...
    <div class="col-md-12">
      ...
      <span id="ftrstxt">
        <img src="images/img.png"> Windows Security </span>
      <span style="font-weight:500;padding-left:13px;color:#fff; ">Call Windows Support: <span style="border:1px solid #fff;border-radius:5px;padding:4px 5px"> <img src="images/call.png" alt="" class="blink" style="width: 25px;vertical-align: middle;">  <script>document.write(phone_number);</script> (US Free Toll Call) 
        </span>
      </span>
      </div>
    </div>
    <div class="col-md-12">
      ...
      <small class="text-left" style="color:#eee;font-size:10px">Windows Defender SmartScreen has blocked an unrecognized app from starting. Running this app might put your computer at risk. Windows Defender scan has found adware on this device that may be stealing passwords, online IDs, financial information, personal files, photos, and documents.</small>
      </marquee>
    </div>
    </div>
  </div>
  ...
  <div class="uprbox" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="upbxs">
    <p style="color:#fff;margin-top:10px;font-size:16px;padding:0 5px" class="text-center">Please contact us immediately. Our engineers will guide you through the removal process over the phone. Your computer has been disabled. Windows Defender SmartScreen has blocked an unrecognized app from starting. Running this app might put your computer at risk. <br>
    <strong>Call Windows Support: <span style="border:1px solid #383d41;border-radius:5px;padding:6px 5px;display: block;"> <img src="images/call.png" alt="" class="blink" style="width: 25px;vertical-align: bottom;"> <script>document.write(phone_number);</script> (US Free Toll Call)
      </span>
    </strong>
    </p>
  </div>
  ...
  <div id="chat" class="bounce" style="display: block;">
    ...
    <h4 style="font-weight:600;font-size:22px"> <img src="images/call.png" alt="" class="blink" style="width: 25px;margin-left: 0;vertical-align:bottom"> <script>document.write(phone_number);</script> <br>(US Free Toll Call)</h4>
